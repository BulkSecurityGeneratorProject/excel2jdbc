...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "e2r@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "e2r API";

        private String description = "e2r API documentation";
